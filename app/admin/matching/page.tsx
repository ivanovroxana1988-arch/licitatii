...
import MatchingManager from "@/components/MatchingManager";
    ...
    <div style={{ minHeight: "100vh" }}>
      <header style={headerStyle}>
        <div>
          ...
          <div style={{ fontSize: 17, fontWeight: 700, marginTop: 2 }}>Matching licitatie</div>
        </div>
        <LogoutButton />
      </header>
      <main style={{ maxWidth: 1180, margin: "0 auto", padding: "24px 16px 44px" }}>
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 14 }}>
          ...
          <Link href="/admin/asocieri" style={secondaryLinkStyle}>Asocieri</Link>
        </div>
        <MatchingManager />
      </main>
    </div>
